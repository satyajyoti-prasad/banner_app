...
<div class="p-6">
    <div class="max-w-2xl mx-auto">
        ...
        <form action="/admin/customers/store" method="post" enctype="multipart/form-data" class="bg-white rounded-lg shadow p-6">
            <?= csrf_field() ?>
            
            <div class="mb-4">
                <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Customer Name</label>
                <input type="text" name="customer_name" id="name" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="mt-1 flex items-center">
                    ...
                    <input type="file" name="customer_logo" id="logo" class="focus:outline-none" required>
                </div>
